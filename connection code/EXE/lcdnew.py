...
class LCD:
    ...
    def loop(self):
       ...
       #lcd = LCD()    
       self.clear()
       self.message1(datetime.now().strftime(' %I: %M: %S \n%a %b %d %Y'))
       sleep(2.5)
       while True:
         self.clear()
         #sleep(1)
         #lcd.scrollDisplayLeft()
         self.message("Please check\nyour schedule.")
         sleep(2.5)
         self.clear()
         ...
         #sleep(1.5)
         #lcd.scrollDisplayLeft()
         self.message("You got a new \nschedule")
         sleep(2.5)
         self.clear() # remember to clear the previous message before turning to the next one
         #lcd.scrollDisplayLeft()
         scroller = Scroller(lines = content)
         #schedule = '\n'.join(content)
         self.message(content) # display the unscrolled lines
         ...
         for i in range(0,36):
            ...
            self.clear()
            self.message(schedule) # display the updated lines
